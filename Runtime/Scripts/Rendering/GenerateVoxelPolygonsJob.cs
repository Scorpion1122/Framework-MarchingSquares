...
namespace Thijs.Framework.MarchingSquares
{
    ...
    public struct GenerateVoxelPolygonsJob : IJobParallelFor
    {
        ...
        private void AddCrossCornerPolygon(FillType fillType, float2 one, float2 two, float2 three, float2 four,
            float2 five, float2 six)
        {
            polygons.Add((int) fillType,
                new Polygon()
                {
        ...
        private void AddThreeCornersPolygon(FillType fillType, float2 one, float2 two, float2 three, float2 four,
            float2 five)
        {
            polygons.Add((int) fillType,
                new Polygon()
